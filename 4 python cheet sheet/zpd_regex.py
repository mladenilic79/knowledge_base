...
random_string = "The ape was at the regex1 apex Cat rat mat fat pat rat cat mat pat"
...
# search for match in start of the string, returns match object (same as search)
