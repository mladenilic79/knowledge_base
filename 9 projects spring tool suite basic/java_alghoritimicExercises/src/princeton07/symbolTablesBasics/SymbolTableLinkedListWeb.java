...
/**
 * The {@code SequentialSearchST} class represents an (unordered) symbol table
 * of generic key-value pairs. It supports the usual <em>put</em>, <em>get</em>,
 ...
 * @author Kevin Wayne
 */
public class SymbolTableLinkedListWeb<Key, Value> {
	 ...
	 */
	public SymbolTableLinkedListWeb() {
	}
	 ...
	 */
	// here put any queue class from princeton library
	...
	public static void main(String[] args) {
		SymbolTableLinkedListWeb<String, Integer> st = new SymbolTableLinkedListWeb<String, Integer>();
		st.put("pera", 3);
		st.put("sima", 5);
