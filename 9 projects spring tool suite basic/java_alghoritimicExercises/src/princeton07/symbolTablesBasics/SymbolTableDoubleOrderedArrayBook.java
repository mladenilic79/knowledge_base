package princeton07.symbolTablesBasics;
 ...
 * <em>floor</em>, <em>select</em>, and <em>ceiling</em>. It also provides a
 ...
 * {@code hashCode()}. The <em>put</em> and <em>remove</em> operations each take
 * linear time in the worst case; the <em>contains</em>, <em>ceiling</em>,
 * <em>floor</em>, and <em>rank</em> operations take logarithmic time; the
 * <em>size</em>, <em>is-empty</em>, <em>minimum</em>, <em>maximum</em>, and
 * <em>select</em> operations take constant time. Construction takes constant
 * time.
 * <p>
 ...
 * implementations, see {@link ST}, {@link BST}, {@link SequentialSearchST},
 * {@link RedBlackBST}, {@link SeparateChainingHashST}, and
 * {@link LinearProbingHashST}, <i>Algorithms, 4th Edition</i> by Robert
 * Sedgewick and Kevin Wayne.
 */
public class SymbolTableDoubleOrderedArrayBook<Key extends Comparable<Key>, Value> {
	 ...
	 */
	public SymbolTableDoubleOrderedArrayBook() {
		this(INIT_CAPACITY);
	}
	 ...
	 */
	public SymbolTableDoubleOrderedArrayBook(int capacity) {
	 ...
	 *                                  {@code null}
	 */
	// put any queue class from here (princeton) and it will work
	...
	public static void main(String[] args) {
		SymbolTableDoubleOrderedArrayBook<String, Integer> st = new SymbolTableDoubleOrderedArrayBook<String, Integer>();
		st.put("pera", 3);
		st.put("sima", 5);
