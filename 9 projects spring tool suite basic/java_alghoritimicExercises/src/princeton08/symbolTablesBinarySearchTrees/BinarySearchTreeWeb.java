package princeton08.symbolTablesBinarySearchTrees;
...
import princeton07.symbolTablesBasics.SymbolTableDoubleOrderedArrayBook;
 ...
 * <em>floor</em>, <em>select</em>, <em>ceiling</em>. It also provides a
 ...
 * <em>remove</em>, <em>minimum</em>, <em>maximum</em>, <em>ceiling</em>,
 ...
 * @author Kevin Wayne
 */
public class BinarySearchTreeWeb<Key extends Comparable<Key>, Value> {
	...
	public Iterable<Key> keys() {
		if (isEmpty())
			return new princeton01.fundamentals.QueueArrayWeb<Key>();
		return keys(min(), max());
	}
	...
	// put any queue class from here (princeton) and it will work
	private void keys(Node x, princeton01.fundamentals.QueueArrayWeb<Key> queue, Key lo, Key hi) {
		if (x == null)
			return;
	...
	public Iterable<Key> levelOrder() {
		princeton01.fundamentals.QueueArrayWeb<Key> keys = new princeton01.fundamentals.QueueArrayWeb<Key>();
		princeton01.fundamentals.QueueArrayWeb<Node> queue = new princeton01.fundamentals.QueueArrayWeb<Node>();
		queue.enqueue(root);
		while (!queue.isEmpty()) {
	...
	public static void main(String[] args) {
		BinarySearchTreeWeb<String, Integer> st = new BinarySearchTreeWeb<String, Integer>();
		st.put("pera", 3);
		st.put("sima", 5);
