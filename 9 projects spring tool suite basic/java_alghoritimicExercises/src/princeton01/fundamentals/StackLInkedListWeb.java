 ...
 * that uses a non-static nested class. See {@link ResizingArrayStack} for a
 * version that uses a resizing array. The <em>push</em>, <em>pop</em>,
 ...
 */
public class StackLInkedListWeb<Item> implements Iterable<Item> {
	...
	public static void main2(String[] args) {
		StackLInkedListWeb<String> stack = new StackLInkedListWeb<String>();
		while (!StdIn.isEmpty()) {
