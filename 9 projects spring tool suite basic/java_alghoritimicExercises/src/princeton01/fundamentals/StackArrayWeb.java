 ...
 * stack of generic items. It supports the usual <em>push</em> and <em>pop</em>
 ...
 * @author Kevin Wayne
 */
public class StackArrayWeb<Item> implements Iterable<Item> {
	...
	public static void main(String[] args) {
		StackArrayBook<String> s = new StackArrayBook<String>();
		s.push("jedan");
		s.push("dva");
		s.push("tri");
		String pop = s.pop();
	...
	public static void main2(String[] args) {
		StackArrayWeb<String> stack = new StackArrayWeb<String>();
		while (!StdIn.isEmpty()) {
