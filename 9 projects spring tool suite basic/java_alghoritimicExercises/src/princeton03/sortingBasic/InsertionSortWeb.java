 ...
 * so it is not suitable for sorting large arbitrary arrays. More precisely, the
 * number of exchanges is exactly equal to the number of inversions. So, for
 * example, it sorts a partially-sorted array in linear time.
 * <p>
 * The sorting algorithm is stable and uses O(1) extra memory.
 * <p>
 * See <a href=
 * "https://algs4.cs.princeton.edu/21elementary/InsertionPedantic.java.html">InsertionPedantic.java</a>
 ...
 * @author Kevin Wayne
 */
public class InsertionSortWeb {

	// This class should not be instantiated.
	private InsertionSortWeb() {
	}
