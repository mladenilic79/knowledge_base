package princeton11.symbolTablesSet;
...
/**
 * The {@code SET} class represents an ordered set of comparable keys. It
 ...
 * <p>
 * Even though this implementation include the method {@code equals()}, it does
 * not support the method {@code hashCode()} because sets are mutable.
 * <p>
 ...
 * {@code equals()} or {@code hashCode()}. The <em>add</em>, <em>contains</em>,
...
public class Set<Key extends Comparable<Key>> implements Iterable<Key> {
	 ...
	 *
	 * @param key the key
	 * @return {@code true} if this set contains {@code key}; {@code false}
	 *         otherwise
	 * @throws IllegalArgumentException if {@code key} is {@code null}
	 */
	...
	/**
	 * Returns all of the keys in this set, as an iterator. To iterate over all of
	 ...
	 * <p>
	 * Note that this method declares two empty sets to be equal even if they are
	 * parameterized by different generic types. This is consistent with the
	 * behavior of {@code equals()} within Java's Collections framework.
	 * 
	 * @param other the other set
	 * @return {@code true} if this set equals {@code other}; {@code false}
	 *         otherwise
	 */
	@Override
	 ...
	 *
	 * @return a string representation of this set, enclosed in curly braces, with
	 *         adjacent keys separated by a comma and a space
	 */
	@Override
