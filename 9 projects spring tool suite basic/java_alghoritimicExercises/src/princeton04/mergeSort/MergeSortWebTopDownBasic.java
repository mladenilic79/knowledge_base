...
/**
 * The {@code Merge} class provides static methods for sorting an array using
 * mergesort.
 * <p>
 ...
 * @author Kevin Wayne
 */
public class MergeSortWebTopDownBasic {

	// This class should not be instantiated.
	private MergeSortWebTopDownBasic() {
	}
	...
	public static void main2(String[] args) {
		...
		MergeSortWebTopDownBasic.sort(a);
		show(a);
	}
}
