 ...
 * @author Kevin Wayne
 */
public class MergeSortWebTopDownOptimised {
	private static final int CUTOFF = 7; // cutoff to insertion sort

	// This class should not be instantiated.
	private MergeSortWebTopDownOptimised() {
	}
	...
	/**
	 * Reads in a sequence of strings from standard input; mergesorts them (using an
	 * optimized version of mergesort); and prints them to standard output in
	 * ascending order.
	 *
	...
	public static void main2(String[] args) {
		...
		MergeSortWebTopDownOptimised.sort(a);
		show(a);
	}
}
