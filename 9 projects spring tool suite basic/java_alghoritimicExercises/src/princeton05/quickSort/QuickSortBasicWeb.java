 ...
 * <a href="https://algs4.cs.princeton.edu/23quick">Section 2.3</a> of
 * <i>Algorithms, 4th Edition</i> by Robert Sedgewick and Kevin Wayne.
 *
 * @author Robert Sedgewick
 * @author Kevin Wayne
 */
public class QuickSortBasicWeb {

	// This class should not be instantiated.
	private QuickSortBasicWeb() {
	}
	 ...
	 * then prints the strings again to standard output, but this time, using the
	 * select method.
	 *
	...
	public static void main2(String[] args) {
		...
		StdOut.println();
		for (int i = 0; i < a.length; i++) {
			String ith = (String) QuickSortBasicWeb.select(a, i);
			StdOut.println(ith);
		}
	}
