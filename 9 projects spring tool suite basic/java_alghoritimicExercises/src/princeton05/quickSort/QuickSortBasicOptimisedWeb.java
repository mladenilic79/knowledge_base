...
public class QuickSortBasicOptimisedWeb {

	private static final int CUTOFF = 8;

	// This class should not be instantiated.
	private QuickSortBasicOptimisedWeb() {
	}
	...
	public static void main(String[] args) {
		...
		QuickSortBasicOptimisedWeb.sort(a);
		show(a);
		assert isSorted(a);
		...
		StdOut.println();
		for (int i = 0; i < a.length; i++) {
			String ith = (String) QuickSortBasicOptimisedWeb.select(a, i);
			StdOut.println(ith);
		}
	}
