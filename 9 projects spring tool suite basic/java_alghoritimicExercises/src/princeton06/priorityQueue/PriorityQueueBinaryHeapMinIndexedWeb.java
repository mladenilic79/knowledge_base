 ...
 * <em>min-key</em>, <em>contains</em>, and <em>key-of</em> operations take
 ...
 */
public class PriorityQueueBinaryHeapMinIndexedWeb<Key extends Comparable<Key>> implements Iterable<Integer> {
	 ...
	 */
	public PriorityQueueBinaryHeapMinIndexedWeb(int maxN) {
		if (maxN < 0)
	...
	private class HeapIterator implements Iterator<Integer> {
		// create a new pq
		private PriorityQueueBinaryHeapMinIndexedWeb<Key> copy;

		// add all elements to copy of heap
		// takes linear time since already in heap order so no keys move
		public HeapIterator() {
			copy = new PriorityQueueBinaryHeapMinIndexedWeb<Key>(pq.length - 1);
			for (int i = 1; i <= n; i++)
	...
	public static void main(String[] args) {
		...
		PriorityQueueBinaryHeapMinIndexedWeb<String> pq = new PriorityQueueBinaryHeapMinIndexedWeb<String>(
				strings.length);
